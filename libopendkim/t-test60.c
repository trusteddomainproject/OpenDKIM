...
#ifndef lint
static char t_test60_c_id[] = "@(#)$Id: t-test60.c,v 1.1 2009/07/16 19:12:04 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha1 verifying with bogus canonicalization\n");
