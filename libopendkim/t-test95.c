...
#ifndef lint
static char t_test95_c_id[] = "@(#)$Id: t-test95.c,v 1.2 2009/07/20 21:41:08 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha1 verifying with granularity mismatch (failure)\n");
