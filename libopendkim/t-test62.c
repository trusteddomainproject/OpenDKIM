...
#ifndef lint
static char t_test62_c_id[] = "@(#)$Id: t-test62.c,v 1.2 2009/07/20 21:41:08 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple verifying with missing \"bh\" tag\n");
	...
	assert(dkim_sig_geterror(sig) == DKIM_SIGERROR_MISSING_BH);
