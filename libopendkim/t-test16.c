...
#ifndef lint
static char t_test16_c_id[] = "@(#)$Id: t-test16.c,v 1.4 2009/11/11 19:40:00 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	{
		printf("*** relaxed/relaxed rsa-sha256 signing SKIPPED\n");
		dkim_close(lib);
		return 0;
	}

	printf("*** relaxed/relaxed rsa-sha256 signing\n");
