...
#ifndef lint
static char t_test35_c_id[] = "@(#)$Id: t-test35.c,v 1.1 2009/07/16 19:12:04 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** simple/simple rsa-sha256 verifying with extra signature spaces (failure) SKIPPED\n");
...
# endif /* TEST_KEEP_FILES */
	...
	printf("*** simple/simple rsa-sha256 verifying with extra signature spaces (failure)\n");
