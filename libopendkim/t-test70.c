...
#ifndef lint
static char t_test70_c_id[] = "@(#)$Id: t-test70.c,v 1.3 2009/07/23 17:40:24 cm-msk Exp $";
#endif /* !lint */
...
#include <string.h>
#include <stdio.h>
#include <regex.h>		/* for TRE_APPROX */
...
{
#if !defined(DKIM_SIGN_RSASHA256) || !defined(TRE_APPROX) || (TRE_APPROX == 0)
	printf("*** relaxed/simple rsa-sha256 verifying with header diffing SKIPPED\n");

#else /* !defined(DKIM_SIGN_RSASHA256) || !defined(TRE_APPROX) || (TRE_APPROX == 0) */
...
# endif /* TEST_KEEP_FILES */
	...
	dkim_close(lib);
#endif /* !defined(DKIM_SIGN_RSASHA256) || !defined(TRE_APPROX) || (TRE_APPROX == 0) */
