...
#ifndef lint
static char t_test104_c_id[] = "@(#)$Id: t-test104.c,v 1.3 2009/07/23 17:40:24 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha1 verifying with future timestamp (failure)\n");
	...
	assert(sig != NULL);
	assert(dkim_sig_geterror(sig) == DKIM_SIGERROR_FUTURE);
