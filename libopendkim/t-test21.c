...
#ifndef lint
static char t_test21_c_id[] = "@(#)$Id: t-test21.c,v 1.2 2009/07/20 21:41:08 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha256 verifying SKIPPED\n");
...
# endif /* TEST_KEEP_FILES */
	...
	printf("*** relaxed/simple rsa-sha256 verifying\n");
