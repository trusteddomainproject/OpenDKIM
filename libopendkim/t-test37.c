...
#ifndef lint
static char t_test37_c_id[] = "@(#)$Id: t-test37.c,v 1.4 2009/11/11 19:40:00 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	{
		printf("*** relaxed/simple rsa-sha256 verifying with signature re-wrapping SKIPPED\n");
		dkim_close(lib);
		return 0;
	}

	printf("*** relaxed/simple rsa-sha256 verifying with signature re-wrapping\n");
