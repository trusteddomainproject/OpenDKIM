...
#ifndef lint
static char t_test39_c_id[] = "@(#)$Id: t-test39.c,v 1.1 2009/11/28 19:02:37 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	{
		printf("*** relaxed/simple rsa-sha256 verifying with extra leading spaces SKIPPED\n");
		dkim_close(lib);
		return 0;
	}

	printf("*** relaxed/simple rsa-sha256 verifying with extra leading spaces\n");
