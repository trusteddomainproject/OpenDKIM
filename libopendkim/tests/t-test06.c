...
#ifndef lint
static char t_test06_c_id[] = "@(#)$Id: t-test06.c,v 1.2 2009/12/08 19:14:27 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	dkim = dkim_verify(lib, "test06", NULL, &status);
	assert(dkim != NULL);
