...
#ifndef lint
static char t_test36_c_id[] = "@(#)$Id: t-test36.c,v 1.2 2009/12/08 19:14:27 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	{
		printf("*** simple/simple rsa-sha256 verifying against no such key SKIPPED\n");
		dkim_close(lib);
		return 0;
	}

	printf("*** simple/simple rsa-sha256 verifying against no such key\n");
