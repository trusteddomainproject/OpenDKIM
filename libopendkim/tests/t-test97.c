...
#ifndef lint
static char t_test97_c_id[] = "@(#)$Id: t-test97.c,v 1.1 2009/11/28 19:02:37 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha1 verifying h= lacking required headers (failure)\n");
	...
	assert(sig != NULL);
	assert(dkim_sig_geterror(sig) == DKIM_SIGERROR_INVALID_H);
