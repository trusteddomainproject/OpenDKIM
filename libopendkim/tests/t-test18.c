...
#ifndef lint
static char t_test18_c_id[] = "@(#)$Id: t-test18.c,v 1.2 2009/12/08 19:14:27 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	{
		printf("*** simple/relaxed rsa-sha256 signing SKIPPED\n");
		dkim_close(lib);
		return 0;
	}

	printf("*** simple/relaxed rsa-sha256 signing\n");
