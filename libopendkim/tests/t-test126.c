...
#ifndef lint
static char t_test126_c_id[] = "@(#)$Id: t-test126.c,v 1.2 2009/12/08 19:14:27 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	{
		printf("*** simple/simple rsa-sha256 verifying with implicit body canonicalization SKIPPED\n");
		dkim_close(lib);
		return 0;
	}

	printf("*** simple/simple rsa-sha256 verifying with implicit body canonicalization\n");
