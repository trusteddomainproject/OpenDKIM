...
#ifndef lint
static char t_test30_c_id[] = "@(#)$Id: t-test30.c,v 1.1 2009/11/28 19:02:37 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	{
		printf("*** simple/relaxed rsa-sha256 verifying with lengths and extra data SKIPPED\n");
		dkim_close(lib);
		return 0;
	}

	printf("*** simple/relaxed rsa-sha256 verifying with lengths and extra data\n");
