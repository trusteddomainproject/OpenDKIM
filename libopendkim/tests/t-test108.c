...
#ifndef lint
static char t_test108_c_id[] = "@(#)$Id: t-test108.c,v 1.2 2009/12/08 19:14:27 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha1 verifying with bogus header canonicalization (failure)\n");
	...
	assert(sig != NULL);
	assert(dkim_sig_geterror(sig) == DKIM_SIGERROR_INVALID_HC);
