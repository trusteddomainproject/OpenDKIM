...
#ifndef lint
static char t_test81_c_id[] = "@(#)$Id: t-test81.c,v 1.2 2009/12/08 19:14:27 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	(void) dkim_set_signer(dkim, "@sub." DOMAIN);
