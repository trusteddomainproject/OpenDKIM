...
#ifndef lint
static char t_test71_c_id[] = "@(#)$Id: t-test71.c,v 1.2 2009/12/08 19:14:27 cm-msk Exp $";
#endif /* !lint */
...
#define	XHDRVALEOL	",\r\n\t"
#define	XHDRVAL		XHDRADDR XHDRVALEOL \
			XHDRADDR XHDRVALEOL \
			XHDRADDR XHDRVALEOL \
			XHDRADDR XHDRVALEOL \
			XHDRADDR XHDRVALEOL \
			...
			XHDRADDR XHDRVALEOL \
			XHDRADDR
#define	XHEADERCC	XHDRNAME XHDRVAL
...
main(int argc, char **argv)
{
	...
	status = dkim_header(dkim, XHEADERCC, strlen(XHEADERCC));
	assert(status == DKIM_STAT_OK);
