...
#ifndef lint
static char t_test31_c_id[] = "@(#)$Id: t-test31.c,v 1.2 2009/12/08 19:14:27 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	{
		printf("*** simple/simple rsa-sha256 verifying with lengths and extra data SKIPPED\n");
		dkim_close(lib);
		return 0;
	}

	printf("*** simple/simple rsa-sha256 verifying with lengths and extra data\n");
