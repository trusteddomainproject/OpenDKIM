...
#ifndef lint
static char t_test83_c_id[] = "@(#)$Id: t-test83.c,v 1.2 2009/12/08 19:14:27 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	{
		printf("*** relaxed/simple rsa-sha256 signing subdomain with i= SKIPPED\n");
		dkim_close(lib);
		return 0;
	}

	printf("*** relaxed/simple rsa-sha256 signing subdomain with i=\n");
...
#define	XHEADER05	"From: Murray S. Kucherawy <msk@eng.sendmail.com>"
	...
	(void) dkim_set_signer(dkim, "@eng.sendmail.com");
