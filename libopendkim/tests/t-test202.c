...
main(int argc, char **argv)
{
	...
	{
		printf("*** relaxed/simple ed25519-sha256 signing with leak detection SKIPPED\n");
		dkim_close(lib);
		return 0;
	}

	printf("*** relaxed/simple ed25519-sha256 signing with leak detection\n");
	...
	dkim = dkim_sign(lib, JOBID, NULL, key, SELECTORRFC8463, DOMAIN,
