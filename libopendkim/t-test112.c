...
#ifndef lint
static char t_test112_c_id[] = "@(#)$Id: t-test112.c,v 1.1 2009/07/16 19:12:04 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha1 verifying with i=/d= mismatch (failure)\n");
	...
	assert(sig != NULL);
	assert(dkim_sig_geterror(sig) == DKIM_SIGERROR_DOMAIN);
