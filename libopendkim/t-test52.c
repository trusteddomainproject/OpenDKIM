...
#ifndef lint
static char t_test52_c_id[] = "@(#)$Id: t-test52.c,v 1.3 2009/07/23 17:40:24 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha256 signing with z-tags\n");
