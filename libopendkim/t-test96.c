...
#ifndef lint
static char t_test96_c_id[] = "@(#)$Id: t-test96.c,v 1.2 2009/07/20 21:41:08 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha1 verifying with empty h= (failure)\n");
	...
	assert(sig != NULL);
	assert(dkim_sig_geterror(sig) == DKIM_SIGERROR_EMPTY_H);
