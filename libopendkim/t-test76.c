...
#ifndef lint
static char t_test76_c_id[] = "@(#)$Id: t-test76.c,v 1.2 2009/07/20 21:41:08 cm-msk Exp $";
#endif /* !lint */
...
#define SIG "v=1; a=rsa-sha1; c=relaxed/simple;"
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha1 malformed signature\n");
