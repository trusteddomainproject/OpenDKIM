...
#ifndef lint
static char t_test79_c_id[] = "@(#)$Id: t-test79.c,v 1.1 2009/07/16 19:12:04 cm-msk Exp $";
#endif /* !lint */
...
#define XHEADER07        "Date   : Thu, 05 May 2005 11:59:09 -0700"

	status = dkim_header(dkim, XHEADER07, strlen(XHEADER07));
	assert(status == DKIM_STAT_OK);
