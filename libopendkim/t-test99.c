...
#ifndef lint
static char t_test99_c_id[] = "@(#)$Id: t-test99.c,v 1.1 2009/07/16 19:12:04 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	assert(sig != NULL);
	assert(dkim_sig_hdrsigned(sig, "from") == TRUE);
	assert(dkim_sig_hdrsigned(sig, "content-type") == FALSE);
