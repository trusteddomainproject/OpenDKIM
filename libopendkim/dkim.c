...
#ifndef lint
static char dkim_c_id[] = "@(#)$Id: dkim.c,v 1.4 2009/07/21 23:36:39 cm-msk Exp $";
#endif /* !lint */
...
DKIM_STAT
dkim_set_trust_anchor(DKIM_LIB *libdkim, char *tafile)
{
	int status;
	...
	status = dkim_unbound_add_trustanchor(libdkim, tafile);
