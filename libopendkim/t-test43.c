...
#ifndef lint
static char t_test43_c_id[] = "@(#)$Id: t-test43.c,v 1.3 2009/07/23 17:40:24 cm-msk Exp $";
#endif /* !lint */
...
main(int argc, char **argv)
{
	...
	printf("*** relaxed/simple rsa-sha256 verifying with extra headers SKIPPED\n");
...
# endif /* TEST_KEEP_FILES */
	...
	printf("*** relaxed/simple rsa-sha256 verifying with extra headers\n");
