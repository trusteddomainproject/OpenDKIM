...
**
**  $Id: opendkim-importstats.c,v 1.10.8.4 2010/10/24 04:39:55 cm-msk Exp $
*/

#ifndef lint
static char opendkim_importstats_c_id[] = "$Id: opendkim-importstats.c,v 1.10.8.4 2010/10/24 04:39:55 cm-msk Exp $";
#endif /* ! lint */
