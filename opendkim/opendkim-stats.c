...
**
**  $Id: opendkim-stats.c,v 1.5.8.1 2009/11/12 06:56:25 grooverdan Exp $
*/

#ifndef lint
static char opendkim_stats_c_id[] = "@(#)$Id: opendkim-stats.c,v 1.5.8.1 2009/11/12 06:56:25 grooverdan Exp $";
#endif /* !lint */
