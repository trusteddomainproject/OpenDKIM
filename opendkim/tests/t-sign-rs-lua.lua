-- $Id: t-sign-rs-lua.lua,v 1.11 2010/09/05 09:11:52 grooverdan Exp $
...
mt.startfilter(binpath .. "/opendkim", "-x", "t-sign-rs-lua.conf", "-p", sock)
mt.sleep(2)
...
mt.macro(conn, SMFIC_MAIL, "i", "t-sign-rs-lua")
