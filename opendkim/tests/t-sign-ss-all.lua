-- $Id: t-sign-ss-all.lua,v 1.1.2.1 2010/07/15 07:38:40 grooverdan Exp $

-- Copyright (c) 2009, 2010, The OpenDKIM Project.  All rights reserved.

-- simple/simple signing test for all domains ("Domain *" in config)
-- 
...
mt.startfilter(binpath .. "/opendkim", "-x", "t-sign-ss-all.conf")
mt.sleep(2)
...
mt.macro(conn, SMFIC_MAIL, "i", "t-sign-ss-all")
