-- $Id: t-sign-ss-macro-value.lua,v 1.7 2010/09/24 21:40:31 cm-msk Exp $
...
mt.startfilter(binpath .. "/opendkim", "-x", "t-sign-ss-macro-value.conf",
               "-p", sock)
...
mt.macro(conn, SMFIC_MAIL, "i", "t-sign-ss-macro-value", "{testmacro}", "testvalue")
