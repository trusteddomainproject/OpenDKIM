-- $Id: t-sign-rs-multiple.lua,v 1.10 2010/09/05 09:11:52 grooverdan Exp $
...
mt.startfilter(binpath .. "/opendkim", "-x", "t-sign-rs-multiple.conf", "-p", sock)
mt.sleep(2)
...
mt.macro(conn, SMFIC_MAIL, "i", "t-sign-rs-multiple")
