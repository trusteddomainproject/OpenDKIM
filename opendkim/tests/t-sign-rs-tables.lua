-- $Id: t-sign-rs-tables.lua,v 1.13 2010/09/06 06:41:47 grooverdan Exp $
...
mt.startfilter(binpath .. "/opendkim", "-x", "t-sign-rs-tables.conf", "-p", sock)
...
mt.macro(conn, SMFIC_MAIL, "i", "t-sign-rs-tables")
...
if string.find(sig, "i=signer@example.com", 1, true) ~= nil then
	error "signature has unexpected i= value"
end
