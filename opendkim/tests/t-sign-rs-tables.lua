-- $Id: t-sign-rs-tables.lua,v 1.1 2010/02/08 04:26:54 cm-msk Exp $
...
mt_echo("*** relaxed/simple signing test using tables")

-- try to start the filter
mt_startfilter("../opendkim", "-x", "t-sign-rs-tables.conf")
mt_sleep(2)
