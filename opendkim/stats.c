...
**
**  $Id: stats.c,v 1.25.8.1 2010/10/18 00:10:32 cm-msk Exp $
*/

#ifndef lint
static char stats_c_id[] = "@(#)$Id: stats.c,v 1.25.8.1 2010/10/18 00:10:32 cm-msk Exp $";
#endif /* !lint */
		...
		else
		{
			...
			if (at != NULL)
			{
				...
				else
				{
					...
					user = dkim_getuser(dkimv);
					if (strncmp(user, p, ulen) == 0)
						user = 2;
					else
						user = 3;
				}
