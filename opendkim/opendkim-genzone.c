...
**
**  $Id: opendkim-genzone.c,v 1.8.2.1 2010/03/09 01:10:36 cm-msk Exp $
*/

#ifndef lint
static char opendkim_genzone_c_id[] = "$Id: opendkim-genzone.c,v 1.8.2.1 2010/03/09 01:10:36 cm-msk Exp $";
#endif /* !lint */
