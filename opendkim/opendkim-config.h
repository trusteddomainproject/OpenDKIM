...
**
**  $Id: opendkim-config.h,v 1.1 2009/07/16 20:59:11 cm-msk Exp $
*/
...
#ifndef lint
static char dkim_config_h_id[] = "@(#)$Id: opendkim-config.h,v 1.1 2009/07/16 20:59:11 cm-msk Exp $";
#endif /* !lint */
...
#ifdef _FFR_COMMAIZE
	{ "Commaize",			CONFIG_TYPE_BOOLEAN,	FALSE },
#endif /* _FFR_COMMAIZE */
