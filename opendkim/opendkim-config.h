...
**
**  $Id: opendkim-config.h,v 1.10.6.2 2010/01/11 20:17:41 cm-msk Exp $
*/
...
#ifndef lint
static char dkim_config_h_id[] = "@(#)$Id: opendkim-config.h,v 1.10.6.2 2010/01/11 20:17:41 cm-msk Exp $";
#endif /* !lint */
