...
**
**  $Id: opendkim-crypto.c,v 1.4.12.1 2009/11/12 04:23:12 grooverdan Exp $
*/

#ifndef lint
static char opendkim_crypto_c_id[] = "@(#)$Id: opendkim-crypto.c,v 1.4.12.1 2009/11/12 04:23:12 grooverdan Exp $";
#endif /* !lint */
