...
**
**  $Id: opendkim-crypto.c,v 1.5.4.2 2010/01/19 14:41:27 cm-msk Exp $
*/

#ifndef lint
static char opendkim_crypto_c_id[] = "@(#)$Id: opendkim-crypto.c,v 1.5.4.2 2010/01/19 14:41:27 cm-msk Exp $";
#endif /* !lint */
