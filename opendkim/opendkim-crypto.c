...
**
**  $Id: opendkim-crypto.c,v 1.5.4.1 2010/01/18 22:39:09 cm-msk Exp $
*/

#ifndef lint
static char opendkim_crypto_c_id[] = "@(#)$Id: opendkim-crypto.c,v 1.5.4.1 2010/01/18 22:39:09 cm-msk Exp $";
#endif /* !lint */
