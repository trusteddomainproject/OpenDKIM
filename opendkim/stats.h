...
**
**  $Id: stats.h,v 1.7.8.8 2010/08/06 18:16:27 cm-msk Exp $
*/
...
#ifndef lint
static char stats_h_id[] = "@(#)$Id: stats.h,v 1.7.8.8 2010/08/06 18:16:27 cm-msk Exp $";
#endif /* !lint */
...
struct dkim_stats_data_v3
{
	...
	u_int		sd_dnssec_insecure;
	u_int		sd_dnssec_secure;
	u_int		sd_adsp_found;
