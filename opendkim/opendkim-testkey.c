...
**
**  $Id: opendkim-testkey.c,v 1.7 2010/06/19 15:29:12 cm-msk Exp $
*/

#ifndef lint
static char opendkim_testkey_c_id[] = "@(#)$Id: opendkim-testkey.c,v 1.7 2010/06/19 15:29:12 cm-msk Exp $";
#endif /* !lint */
