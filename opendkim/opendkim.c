...
**
**  $Id: opendkim.c,v 1.63.2.17 2009/11/25 18:57:42 cm-msk Exp $
*/

#ifndef lint
static char opendkim_c_id[] = "@(#)$Id: opendkim.c,v 1.63.2.17 2009/11/25 18:57:42 cm-msk Exp $";
#endif /* !lint */
	...
	*/
	...
	if (dfc->mctx_srhead != NULL)
	{
		...
		for (sr = dfc->mctx_srhead; sr != NULL; sr = sr->srq_next)
		{
			if (sr->srq_key != NULL)
			{
				keydata = sr->srq_key->key_data;
				selector = sr->srq_key->key_selector;
